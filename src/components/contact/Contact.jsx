...
const Contact = () => {
    ...
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        <BiLogoGmail className="contact__card-icon" />
                        
                        <h3 className="contact__card-title">Email</h3>
                        <span className="contact__card-data">prakash.cmd19@gmail.com</span>
                        
                        <a href="mailto:prakash.cmd19@@gmail.com" className="contact__button">
                            Write Me{" "} 
            ...
            <div className="contact__content">
                <h3 className="contact__title">What's the message?</h3>
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    ...
                    <div className="contact__form-div">
                        ...
                        <input type="email" name="reply_to" className="contact__form-input" placeholder="Type your email" />
                    </div>
